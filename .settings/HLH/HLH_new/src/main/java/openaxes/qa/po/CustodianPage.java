...
public class CustodianPage extends BasePage{
	...
	@FindBy(xpath = "(//div[@class='form-group'])[10]/div/div/button[1]")
	...
	public void clickActivate(){
		  new WebDriverWait(driver,30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//span/button)[1]")));
		  clickActivate.click();
	...
	public void clickSubmitForApproval() {
		new WebDriverWait(driver,30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[contains(.,'Submit for approval')]")));
